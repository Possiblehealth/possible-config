...
FROM
    ...
    WHERE
        icd10_code IN ('A86' , 'B74.9', 'B54', 'B49', 'B51', 'A90', 'B55.0', 'B55.9', 'A01.0', 'A09.9', 'A06.9', 'A03.9','K52.9','A00.9','B82.0','R17','B17','E86')) first_answers
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view dcv ON dcv.concept_id = o.value_coded
        AND dcv.icd10_code IN ('A86' , 'B74.9', 'B54', 'B49', 'B51', 'A90', 'B55.0', 'B55.9', 'A01.0', 'A09.9', 'A06.9', 'A03.9','K52.9','A00.9','B82.0','R17','B17','E86')
    WHERE
...
ORDER BY FIELD(first_answers.icd10_code,'A86' , 'B74.9', 'B54', 'B49', 'B51', 'A90', 'B55.0', 'B55.9', 'A01.0', 'A09.9', 'A06.9', 'A03.9','K52.9','A00.9','B82.0','R17','B17','E86')
